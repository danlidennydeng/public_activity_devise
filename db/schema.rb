...
ActiveRecord::Schema.define(version: 20170112225400) do
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.index ["place_id"], name: "index_addresses_on_place_id", using: :btree
  end
  ...
  create_table "interactions", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["interactive_type", "interactive_id"], name: "index_interactions_on_interactive_type_and_interactive_id", using: :btree
  end
